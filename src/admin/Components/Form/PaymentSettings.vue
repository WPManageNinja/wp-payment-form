                        ...
                        <div class="sub_section_body">
                            <el-form-item label="Currency & Locale Setting">
                                <el-radio-group v-model="currency_settings.settings_type">
                                    <el-radio border label="global">{{ $t('As Per Global Settings') }}</el-radio>
                            ...
                            <template v-if="currency_settings.settings_type == 'custom'">
                                <el-form-item label="Stripe Checkout Locale">
                                    <el-select size="small" filterable v-model="currency_settings.locale" placeholder="Select Stripe Checkput Language">
                                        <el-option
                                ...
                                <el-form-item label="Currency">
                                    <el-select size="small" filterable v-model="currency_settings.currency" placeholder="Select Currency">
                                        <el-option
